...
function About({ content }) {
    ...
    return <Layout>
        ...
        <section className="uk-section uk-section-small uk-background-gradient-primary section-about-count-text">
            <div className="uk-container">
                <div className="uk-width-5-6@m uk-margin-auto">
                    <div className="uk-grid uk-grid-medium uk-flex-between uk-flex-bottom" data-uk-grid>
                        <div className="uk-width-1-2@m">
                            <h2>{content.content.IcerikBaslik}</h2>

                            <div dangerouslySetInnerHTML={{__html: content.content.Icerik}}></div>
                        </div>

                        <div className="uk-width-auto@m">
                            <img src={mediaUrl + content.content.IcerikSagGorsel.Url} alt="" className="uk-border-rounded" width="400" />
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section className="uk-section uk-section-large section-about-count-card">
            <div className="uk-container">
                <div className="uk-grid uk-grid-medium uk-light uk-text-center" data-uk-grid>

                    {content.content.BilgiKartlari.map((e, index) => (

                        <div key={index} className="uk-width-4-5 uk-width-1-2@s uk-width-1-3@m uk-width-1-4@l">
                            <div className="uk-position-relative overlay-secondary">
                                <img src={mediaUrl + e.Arkaplan.Url} alt="" className="uk-border-rounded" />
        ...
        <section className="uk-section uk-background-tertiary uk-light" data-src="/images/section/about-stories.svg" uk-img="">
            <div className="uk-container">
                <h2 className="uk-margin-medium uk-text-center">{content.content.UlkelerBaslik}</h2>
                <div className="uk-width-2-3@m uk-margin-auto">
                    ...
                    <div className="uk-text-center">
                        <a href={content.content.UlkelerButtonLink} className="uk-button uk-button-primary">{content.content.UlkelerButtonYazi}</a>
                    </div>
                </div>
            </div>
        </section>
                        ...
                        <ul className="uk-accordion uk-margin-remove" data-uk-accordion>
                            ...
                            {content.content.Listeler.map((e, index) => (
                                <li key={index} className={index === 0 ? 'uk-open' : ''}>
                                    <a className="uk-accordion-title" href="#">{e.Baslik}</a>
        ...
        <section className="uk-section uk-background-cover uk-height-xlarge uk-position-relative" data-src={mediaUrl + content.content.AltBanner[0].Gorsel.Url} uk-img="">
